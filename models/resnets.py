...
def resnet20s(**kwargs):
    return ResNets(torch.nn.Conv2d, torch.nn.Linear, BasicBlock, [3, 3, 3], **kwargs)


def resnet32s(**kwargs):
    return ResNets(torch.nn.Conv2d, torch.nn.Linear, BasicBlock, [5, 5, 5], **kwargs)

def resnet44s(**kwargs):
    return ResNets(torch.nn.Conv2d, torch.nn.Linear, BasicBlock, [7, 7, 7], **kwargs)

def resnet56s(**kwargs):
    return ResNets(torch.nn.Conv2d, torch.nn.Linear, BasicBlock, [9, 9, 9], **kwargs)